defmodule PredictedSchedule.Repo do
  ...
  ####### various functions to transform predicted schedules into other useful things, adapted from TNM. basically things that already only take predicted schedules as input.
  @type schedule_data :: %{
          Route.id_t() => %{
